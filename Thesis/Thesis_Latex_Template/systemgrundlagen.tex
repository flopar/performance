...
\begin{figure}[!htbp]
	\centering
	\subfigure[Cortex M4 Stack]{\label{fig:a}\includegraphics[scale=0.65]{../figures/systemgrundlagen/cortex_m4_stack.jpg}}
	\subfigure[Cortex M4 Special Regsiters]{\label{fig:b}\includegraphics[scale=0.8]{../figures/systemgrundlagen/cortex_m4_special_registers.jpg}}
