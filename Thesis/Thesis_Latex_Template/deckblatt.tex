	...
	\begin{flushleft}
		\begin{spacing} {1.2}
			...
			\LARGE
				...
				Florian Pîrvu\\
				\vspace{60pt}		
				Arbeitstitel:	C++ Crossplatform Bibliothek zur Performanceanalyse\\ \hspace{31mm}von Anwedungen unter dynamisch generierten Lasten\\
				\vspace{60pt}		
			\LARGE
				Erstpr\"ufer: Prof. Dr. Thomas Kirchmeier\\
